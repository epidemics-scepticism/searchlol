...
static const unsigned char *vowels[] = {
	...
	"i", "o", "ea", "ou", "ie", "ai", "ee", "au", "oo", NULL,
};

static const unsigned char *consonants[] = {
	"b", "c", "d", "g", "h", "j", "k", "l", "m", "n", "p", "r", "s", "t",
	"v", "w", "y", "z", "tr", "cl", "cr", "br", "fr", "th", "dr", "ch",
	"st", "sp", "sw", "pr", "sh", "gr", "tw", "wr", "ck", NULL,
};

static PRONOUNCE *
new_pronounce_internal(void)
{
...
static bool
populate_pronounce_internal(PRONOUNCE *root, const unsigned char **syl)
{
...
static bool
search_pronounce_internal(PRONOUNCE *p, const unsigned char *o, bool cons)
{
...
static void
destroy_pronounce_internal(PRONOUNCE *p)
{
	if (p->next) {
